...
デフォルトで軸の個数や大きさが決められていて、軸の名前だけ編集する形も候補にありましたが、<br>
ユーザーによって必要な軸の数も異なると考え、新たな軸（リスト）を右側へ追加する、現在の仕様にたどり着きました。<br>
また、今回初めてBootstrapを導入しましたが、なかなか思う通りの実装ができず苦労しました。<br>
公式ドキュメントは英語で記載されており、他の情報もrubyバージョンが古いものに関するものが多く、適用できないことが多々ありました。<br>
試行錯誤を重ねた結果ゴミ箱やペンのアイコンが表示され、１から情報を集め、開発に成功する喜びを感じることができました。<br>
