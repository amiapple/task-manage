...
## 苦労した点
軸を自由に作成できる仕様にしたものの、トップページを見やすく、使いやすくするレイアウトや構成の考案に時間を割きました。<br>
デフォルトで軸の個数や大きさが決められていて、軸の名前だけ編集する形も候補にありましたが、やはりユーザーによって必要な軸の数も異なると考え<br>
新たな軸（リスト）を右側へ追加していく、現在の仕様にたどり着きました。<br>
また、今回初めてBootstrapを導入しましたが、なかなか思う通りの実装ができず苦労しました。<br>
公式ドキュメントは英語で記載されており、他の情報もrubyバージョンが古いものに関するものが多く、そのまま適用できないことが多々ありました。<br>
試行錯誤を重ねた結果ゴミ箱やペンといったアイコンが表示され、１から情報を集め、開発に成功する喜びを感じることができました。<br>
